...
RANK_HELP_TEXT = format_html(_('Twoja aktualna siła w <a href="#" data-bs-toggle="modal" data-bs-target="#gor-modal">punktach GoR</a>. Jeżeli dopiero zaczynasz przygodę z Go wpisz 100.'))
...
AGREEMENT_HELP_LABEL = format_html(_("Zapoznałem się i zgadzam się z <a href='/rules'>regulaminem ligi</a>"))
