...
SEASON_STATE_IN_PROGRESS = _("Trwa")
...
GAME_REPORT_RESULT_SUCCESS = _("Wynik gry został zapisany.")
WRONG_SEASON_STATE_ERROR = _("Nie możesz wykonać tej akcji - seazon znajduje się w nieodpowiednim stanie.")
CAN_NOT_REPORT_GAME_RESULT_ERROR = _("Nie można wprowadzić wyniku gry.")
GAME_REVIEW_SUBMITTED_SUCCESS = _("Komentarz do gry został zapisany.")
