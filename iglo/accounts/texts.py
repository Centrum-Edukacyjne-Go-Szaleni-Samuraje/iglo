...
FIRST_NAME_HELP_TEXT = _("Twoje imie będzie widoczne dla administratorów ligi oraz Twoich przeciwników.")
...
RANK_HELP_TEXT = mark_safe(_('Twoja aktualna siła w <a href="#" data-bs-toggle="modal" data-bs-target="#gor-modal">punktach GoR</a>. Jeżeli dopiero zaczynasz przygodę z Go wpisz 100.'))
...
PASSWORD_HELP_TEXT = _("Wybierz trudne hasło oraz składające się z conajmniej 8 znaków.")
FIRST_NAME_LABEL = _("Imie")
LAST_NAME_LABEL = _("Nazwisko")
AGREEMENT_HELP_LABEL = mark_safe(_("Zapoznałem się i zgadzam się z <a href='/rules'>regulaminem ligi</a>"))
